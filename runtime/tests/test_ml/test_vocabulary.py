...
class TestVocabulary:
    ...
    def test_common_signs_present(self):
        ...
        expected = {
            "OI", "TUDO-BEM", "OBRIGADO", "POR-FAVOR", "SIM", "NAO",
            "EU", "VOCE", "CASA", "ESCOLA", "PROFESSOR", "ALUNO",
            "ESTUDAR", "APRENDER", "AJUDA", "ENTENDER", "GOSTAR",
            "QUERER", "PRECISAR", "DESCULPA", "BOM", "MAU",
            "GRANDE", "PEQUENO", "HOJE", "AMANHA", "ONTEM",
            "NUMERO", "NOME", "AGUA",
        }
